...
def export_results_to_stream(results_to_export: dict):
    ...
    with pd.ExcelWriter(output_stream, engine="openpyxl") as writer:
        ...
        def write_sheet(sheet_name: str, df_key: str):
            df = _to_dataframe(results_to_export.get(df_key))
        ...
        podft_45m_bo_df = _to_dataframe(raw_podft_45m)
        ...
        crypto_deals_df = _to_dataframe(raw_crypto)

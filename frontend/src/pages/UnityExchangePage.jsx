    ...
    <div style={{ height: "100%", display: "flex", flexDirection: "column", minHeight: 0 }}>
      <div style={{ display: "flex", gap: 10, alignItems: "center", padding: 12, borderBottom: "1px solid #e2e8f0" }}>
        ...
        <select
          ...
          style={{ height: 36, borderRadius: 8, border: "1px solid #e2e8f0", padding: "0 10px", fontWeight: 400 }}
        >
      ...
      {result && (
        ...
        >
          ...
          <div style={{ padding: 12, borderBottom: "1px solid #f1f5f9", fontSize: 12, color: "#475569", lineHeight: 1.5 }}>
            <span style={{ fontWeight: 500 }}>{result.exchange_name}</span> rows: {result.summary.rows_exchange} |{" "}
            <span style={{ fontWeight: 500 }}>Unity</span> rows: {result.summary.rows_unity} | STRICT: {result.summary.matched_strict} | FUZZY:{" "}
            {result.summary.matched_fuzzy} | NOTIONAL: {result.summary.matched_notional} | Missing: {result.summary.missing_in_unity} | Extra:{" "}

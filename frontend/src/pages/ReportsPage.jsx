                    ...
                    >
                      <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                        ...
                        <span style={{ color: "#334155" }}>
                          {clientDetails.email || "Email не указан"}
                        </span>
                      </div>
                      <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                        <Briefcase size={16} color="#94a3b8" />{" "}
                        <span style={{ color: "#334155" }}>
                          {clientDetails.account_number || "Счет не указан"}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    >
                      <h4 style={{ margin: 0, fontSize: "16px" }}>
                        Файлы ({clientDetails.files ? clientDetails.files.length : 0})
                      </h4>
                      <label
                        className="btn"
    ...
    <div className="card" style={{ width: "400px", padding: "30px", position: "relative" }}>
      ...
      <div className="input-group">
        ...
        <input
          ...
          onChange={(e) => setData({ ...data, folder_path: e.target.value })}
        />
      </div>
      <div style={{ display: "flex", justifyContent: "flex-end", gap: "10px", marginTop: "20px" }}>
        <button className="btn" style={{ background: "#94a3b8" }} onClick={onClose}>
          Отмена
        </button>
